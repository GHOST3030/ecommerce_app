class AppConfig {
  ...
  static const String authRedirectUrl = String.fromEnvironment(
    'AUTH_REDIRECT_URL',
    defaultValue: 'ecommerceapp://auth-callback',
  );
  static const String emailVerificationRedirectUrl = String.fromEnvironment(
  ...
  static void validate() {
    ...
    if (supabaseAnonKey.isEmpty) {
      throw StateError(
        ...
        'Pass it via --dart-define=SUPABASE_ANON_KEY=...',
      );
    }
  }
}
